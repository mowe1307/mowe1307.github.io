...
const insertZ = ["sports and music", "reading and knitting", "makeup and movies", "butter churning and cattle ranching", "throwing eggs and stealing cars","designing clothes for chihuahas and opening pizza stores under the sea"];
const imgLink= ["img/Gru.png","img/voldemort.png","img/witches.png","img/Dude.png","img/edna.png","img/jack.png"];
